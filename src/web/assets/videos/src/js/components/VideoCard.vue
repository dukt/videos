<template>
    <div class="dv-group" @click="selectVideo(video)" @dblclick="useVideo(video)">
        ...
        <div class="dv-mt-2 dv-flex dv-flex-row dv-flex-nowrap dv-items-center">
            <template v-if="video.private">
                <svg xmlns="http://www.w3.org/2000/svg" class="dv-h-4 dv-w-4 dv-mr-1"
            ...
            <div class="dv-flex-1 line-clamp-2">{{video.title}}</div>
        </div>
    </div>
</template>
